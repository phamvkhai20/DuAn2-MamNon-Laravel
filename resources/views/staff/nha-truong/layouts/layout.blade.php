...
<script src="{{asset('assets_staff/demo/default/custom/crud/forms/widgets/bootstrap-markdown.js')}}" type="text/javascript">
    <script src="{{asset('assets_staff/app/js/dashboard.js')}}" type="text/javascript"></script>
    <script src="{{ asset('ckeditor/ckeditor.js') }}"></script>
<script> CKEDITOR.replace('w3review'); </script>
</body>
