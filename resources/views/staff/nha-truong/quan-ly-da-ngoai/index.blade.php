...
@section('title','Danh sách picnic')
@section('content')
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="1" colspan="1">Địa điểm</th>
                                            <th rowspan="1" colspan="1">Chi phí</th>
                                            <th rowspan="1" colspan="1">Tên phụ huynh</th>
                                    ...
                                    <tbody>
                                        @foreach($picnic as $pc)
                                        <tr role="row" class="odd">
                                            <td class="sorting_1" tabindex="0">{{$pc->id}}</td>
                                            <td>{{$pc->name}}</td>
                                            <td>{{$pc->time}}</td>
                                            <td>{{$pc->address}}</td>
                                            <td>{{$pc->price}}</td>
                                            <td>{{$pc->name_parent}}</td>
                                            <td>
                                            <img src="{{asset('/upload/avatar/'.$pc->picnic_avatar)}}" alt="avatar"
                                                    style="width:50px;border-radius: 10px;">
                                            </td>
                                            <td>{!!$pc->description!!}</td>
                                            <td>
                                                <a href="sua/{{$pc->id}}" class="btn btn-warning btn-sm ">Sửa</a>&nbsp;
                                                <a href="#"
