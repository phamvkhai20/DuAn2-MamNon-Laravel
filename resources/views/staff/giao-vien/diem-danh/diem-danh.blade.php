                    ...
                    <div class="tab-pane " id="m_tabs_5_1" role="tabpanel">
                        ...
                        <form class="row" action="{{ route('giao-vien.diem_danh_den')}}" method="post">
                            ...
                            <div class=" col image_kid_attendance m-portlet d-flex justify-content-center"
                                style="background-image: url({{asset('/upload/avatar/'.$kid->kid_avatar)}});border:5px solid #5867dd">
                                @else
                                <div class=" col image_kid_attendance m-portlet d-flex justify-content-center"
                                    ...
                                    <div class="box_group_name">
                                        ...
                                        <input hidden type="text" value="{{$kid->class_id}}"
                                            name="class_id[{{$kid->id}}]" />
                                    </div>
                                    <div class="box_more">
                                        <a href="#" class="button_khac" data-toggle="modal"
                                            data-target="#m_modal_1_2_{{$kid->id}}"
                                    ...
                                    <div class="box_group_button">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <span
                                                    class="m-switch m-switch--outline m-switch--icon m-switch--primary">
                                                    <label style="margin-bottom:0">
                                                        <input type="checkbox" id="status_{{$kid->id}}"
                                                            checked="checked" onchange="handleClickP('{{$kid->id}}')"
                                                            name="status[{{$kid->id}}]">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            ...
                                            <div id="meal[{{$kid->id}}]" class="col-6">
                                                ...
                                                <span
                                                    class="m-switch m-switch--outline m-switch--icon m-switch--accent">
                                                    <label style="margin-bottom:0">
                                                        <input type="checkbox" checked="checked" id="meal_{{$kid->id}}"
                                                            onchange="handleClickP('M{{$kid->id}}')"
                                                            name="meal[{{$kid->id}}]">
                                                        <span></span>
                                                    </label>
                                                </span>
                                                ...
                                                <span
                                                    class="m-switch m-switch--outline m-switch--icon m-switch--accent">
                                                    <label style="margin-bottom:0">
                                                        <input type="checkbox" id="meal_{{$kid->id}}"
                                                            onchange="handleClickP('M{{$kid->id}}')"
                                                            name="meal[{{$kid->id}}]">
                                                        <span></span>
                                                    </label>
                                    ...
                                    <div class="modal fade" id="m_modal_1_2_{{$kid->id}}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div>
                                                        <input hidden type="text"
                                                            value="Xin nghỉ trên hệ thống nhưng có đi học"
                                                            name="note[{{$kid->id}}]" />
                                                        <span
                                                            class=" col-6 m-switch m-switch--outline m-switch--success">
                                                            <label style="margin-bottom: 5px;margin-left:10px">
                                                                <input hidden type="text" value="2"
                                                                    name="status[{{$kid->id}}]" />
                                                                <input data-switch="true"
                                                                    onchange="handleClickP('S{{$kid->id}}')"
                                                                    type="checkbox" name="status[{{$kid->id}}]"
                                                                    data-on-color="success" data-on-text="Đ"
                                                                    data-off-color="danger" data-off-text="N">
                                                            </label>
                                                        </span>
                                                        <span id="meal[{{$kid->id}}]"
                                                            class="col-6 m-switch m-switch--outline m-switch--success ">
                                                            <input type="text" hidden value="off"
                                                                name="meal[{{$kid->id}}]" />
                                                            <input data-switch="true"
                                                                onchange="handleClickP('M{{$kid->id}}')" type="checkbox"
                                                                name="meal[{{$kid->id}}]" data-on-color="success"
                                                                data-on-text="A" data-off-color="danger"
                                                                data-off-text="K">
                                                        </span>
                                                    </div>
                                                    @endif
                    ...
                    @if($date<"12:00") <div class="tab-pane " id="m_tabs_5_2" role="tabpanel">
                        ...
                        <div class="tab-pane active" id="m_tabs_5_2" role="tabpanel">
                            ...
                            <form class="row" action="{{ route('giao-vien.diem_danh_ve')}}" method="post">
                                ...
                                <div class=" col image_kid_attendance m-portlet d-flex justify-content-center"
                                    style="background-image: url({{asset('/upload/avatar/'.$attendance->kid->kid_avatar)}});border:5px solid #5867dd">
                                    @else
                                    <div class=" col image_kid_attendance m-portlet d-flex justify-content-center"
                                        ...
                                        <div class="box_group_name">
                                            ...
                                            <input hidden type="text" value="{{$attendance->kid->class_id}}"
                                                name="class" />
                                            ...
                                            <input hidden type="text" value="true"
                                                name="check_diem_danh_ve[{{$attendance->kid->id}}]" />
                                            @endif
                                            <input hidden type="text" value="null"
                                                    ...
                                                    <textarea class="form-control" name="note[{{$attendance->kid->id}}]" placeholder="Nhập thông tin khác" rows="6">{{$attendance->note=="null"?"":$attendance->note}}</textarea>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 d-flex justify-content-center"><img
                                                                    ...
                                                                    style="width:50%;float:right" alt=""></div>
                                                        </div>
