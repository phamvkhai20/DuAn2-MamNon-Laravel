                                ...
                                <div class="box_group_button">
                                    <div class="row">
                                        ...
                                        m-switch--success ">
                                            ...
                                            <input data-switch="true" type="checkbox" checked="checked" name="meal[{{$kid->id}}]" data-on-color="success" data-on-text="A" data-off-color="danger" data-off-text="K">
                                            @else
                                            <input data-switch="true" type="checkbox" name="meal[{{$kid->id}}]" data-on-color="success" data-on-text="A" data-off-color="danger" data-off-text="K">
                                            @endif
                                        </span>
                                        @endif
                                    </div>
