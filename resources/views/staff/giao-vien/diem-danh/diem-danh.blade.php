                ...
                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <span class=" col-6 m-switch m-switch--outline m-switch--success">
                                            <label style="margin-bottom: 5px;margin-left:10px">
                                                <input hidden type="text" value="off" value="" name="status[{{$kid->id}}]" />
                                                @if(!empty($kid->attendance[0])&&$kid->attendance[0]->status==1)
                                                <input data-switch="true" type="checkbox" checked="checked" name="status[{{$kid->id}}]" data-on-color="success" data-on-text="P" data-off-color="danger" data-off-text="A">
                                                @else
                                                <input data-switch="true" type="checkbox" name="status[{{$kid->id}}]" data-on-color="success" data-on-text="P" data-off-color="danger" data-off-text="A">
                                                @endif
                                            </label>
                                        </span>
                                        <div class="col-6">
                                            <a href="#" class="button_khac" data-toggle="modal" data-target="#m_modal_1_2" class="m-portlet__nav-link m-dropdown__toggle btn m-btn m-btn--link" style="padding: 0;padding-top:15px;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="200">
                                                    ...
                                                    <input data-switch="true" type="checkbox" checked="checked" name="meal[{{$kid->id}}]" data-on-color="success" data-on-text="P" data-off-color="danger" data-off-text="A">
                                                </div>
                                            </div>
                    ...
                    <div class="tab-pane" id="m_tabs_5_2" role="tabpanel">
                        ...
                        <form class="row" action="{{ route('giao-vien.diem_danh_ve')}}" method="post">
                            ...
                            <div class=" col image_kid_attendance m-portlet d-flex justify-content-center" style="background-image: url({{asset('/upload/avatar/'.$attendance->kid->kid_avatar)}})">
                                ...
                                <div class="box_group_button">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="button_khac" data-toggle="modal" data-target="#m_modal_1_3" class="m-portlet__nav-link m-dropdown__toggle btn m-btn m-btn--link" style="padding: 0;padding-top:15px;">
                                                <i class="la la-ellipsis-h icon_button_khac"></i>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <script>
                                var d = new Date();
                                document.getElementById("dates[{{$attendance->kid->id}}]").value = d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate();
                                document.getElementById("leave_time[{{$attendance->kid->id}}]").value = d.getHours() + ':' + (d.getMinutes()) + ':' + d.getSeconds();
                            </script>
                            @endforeach
                            <div class="m-nav-sticky" style="margin-top: 30px;width:100px;height:100px">
                                <li class="m-nav-sticky__item" data-toggle="m-tooltip" data-placement="left">
